...
class WwwServer(val port: Int, val staticDir: String) {
      ...
      createHTML().html {
        ...
        body {
          ...
          ul {
            ...
            li { a { href = "/tinyurl"; text(s = "tinyurl") } }
          }
        }
      }
    }
  ...
  private suspend fun PipelineContext<Unit, ApplicationCall>.tinyResolved() {
    call.respondText(ContentType.Text.Html) {
      createHTML().html {
        head {
          title("tinyresolved")
        ...
        body {
          text(s = "tinyresolved empty page")
        }
      }
    }
  }
