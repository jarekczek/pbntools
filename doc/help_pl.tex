...
\subsubsection{Problem z wget OpenSSL}
W tej chwili po³±czenie wget z serwerem Bbo nie dzia³a.
Wersja, któr± za³±czam, jest za stara.
Mo¿na spróbowaæ zast±piæ j± jak±¶ inn± wersj±, np. pobran± st±d:
\htmladdnormallink{Eternally Bored}{https://eternallybored.org/misc/wget/} .
Nale¿y podmieniæ j± w katalogu \verb!PbnTools\bin\wget! .
...
\item[1.3.1, 19.05.2021]
  \begin{itemize}
  \item Tylko zmiany w dokumentacji (opis problemu wget openssl)
  \end{itemize}
