...
\item[ZBar]
  \htmladdnormallink{ZBar}{http://zbar.sourceforge.net/} to biblioteka
  o funkcjonalno¶ci czytnika kodów paskowych,
  rozprowadzana na licencji LGPL 2.1 (lub pó¼niejsza).
  Czyta pliki graficzne lub obraz z kamery internetowej.
  Zastosowana zosta³a tutaj okrojona wersja odczytuj±ca obraz z kamery. Plik z licencj±: zbar\_LICENSE.txt
...
\item[msys]
  ¦rodowisko skryptowe z Linuxa dzia³aj±ce pod Windows, a wiêc przede wszystkim {\em bash}. 
  Wykorzystana jest czê¶æ plików z wersji 
  ...
  Msys bêd±c pakietem wielu ró¿nych programów nie ma jednej licencji.
  Sprawa opisana jest na stronie
  \htmladdnormallink{msys}{http://www.mingw.org/wiki/MSYS},
  w sekcji \htmladdnormallink{Licensing Terms}{http://www.mingw.org/%
  license}.
  Po pobraniu pliku z kodem ¼ród³owym mo¿na zapoznaæ siê ze szczegó³ami licencji poszczególnych komponentów.
\item[wget]
...
\subsection{Pobierz Kops} \label{pobKops}
  ...
  u \htmladdnormallink{Krzysztofa Jassema}{http://www.jassem.republika.pl}
...
\begin{itemize}
\item XXX\_wyn.pbn - plik z rozdaniami i wynikami - na podstawie tego pliku generujemy turniej w Jacku
\item XXX.pbn - plik z rozdaniami turnieju (XXX to nazwa turnieju, np. MCH0308)
\item roz.html - lista travellerów ca³ego turnieju
\item link.html - zawiera link do orygina³u turnieju, u³atwiaj±cy analizê porozdaniow±
\item pNN.html - traveller dla rozdania o numerze NN
\end{itemize}
...
Ze wzglêdu na wykorzystanie programów {\em bash} oraz {\em zbar} wymagane s±
...
\begin{itemize}
\item
  Plik dla \htmladdnormallink{Windows}{http://jarek.katowice.pl/jcwww/pbntools/PbnTools_1_0_0_win.zip}
\item
  Plik dla \htmladdnormallink{Linux}{http://jarek.katowice.pl/jcwww/pbntools/PbnTools_1_0_0_linux.zip}
% \item
...
Program napisany jest g³ównie w Javie, aczkolwiek s± jeszcze relikty w bashu,
które mam nadziejê z czasem usun±æ.
...
\item
  ...
  \htmladdnormallink{Przegl±danie on-line}{https://sourceforge.net/p/pbntools/code/}
