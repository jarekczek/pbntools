...
public class Deal implements Cloneable {
  ...
  private boolean wczytajTagDeal(String sDeal) { //{{{
    ...
    try {
      ...
      nKolor = 1;
      k = new Card();
      if (sDeal.charAt(nPoz+=1) != ':') { System.err.println("B��d sk�adni pliku PBN. W tagu deal na pozycji 2 powinien by� znak :"); return false; }
      while (cKarty<52) {
        ...
        if (ch=='.') {
          ...
          if (!k.isOk()) { System.err.println("B��d sk�adni pliku PBN. B��dna wysoko�� karty: "+ch);return false; }
    ...
    if (cOsoby!=4) { System.err.println("B��d sk�adni pliku PBN. Wczytano karty tylko "+cOsoby+" os�b"); return false; }
    return true;
    } //}}}
